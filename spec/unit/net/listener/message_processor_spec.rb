    ...
    context 'throws exceptions' do
      context 'not authorized' do
        it 'cannot be decrypted' do
          ...
          end.to raise_error Meshchat::Net::Listener::Errors::NotAuthorized
        end
      end
      ...
      context 'forbidden' do
        it 'receives a message from a non-existant node' do
          ...
          expect do
            klass.process(raw, message_dispatcher: message_dispatcher)
          end.to raise_error Meshchat::Net::Listener::Errors::Forbidden
        end
      end
      ...
      context 'bad request' do
        it 'uses an unsupported type' do
          ...
          expect do
            klass.process(raw, message_dispatcher: message_dispatcher)
          end.to raise_error Meshchat::Net::Listener::Errors::BadRequest
        end
      end
    end
  end
